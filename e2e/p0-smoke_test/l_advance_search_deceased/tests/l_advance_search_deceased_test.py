...
def test_example(page: Page) -> None:
    ...
    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-interment-form-div-title-deceased").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-interment-form-div-title-deceased")).to_be_visible()

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-john").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-john")).to_be_visible()
    page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-john").click(delay=200)
    page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-john").fill("budi")

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-doe").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-doe")).to_be_visible()
    page.get_by_test_id("customer-organization-astana-tegal-gundul-mat-form-field-input-doe").click(delay=200)
    ...
    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-search-advance-advance-search-result-span-plot-id-title").wait_for(state='visible', timeout=10000)
