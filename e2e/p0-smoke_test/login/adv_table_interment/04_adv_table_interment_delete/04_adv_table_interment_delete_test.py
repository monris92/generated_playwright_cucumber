...
def test_example(page: Page) -> None:
    ...
    page.get_by_test_id("customer-organization-astana-tegal-gundul-a20z202-manage-edit-interment-ng-component-div-buttons").get_by_role("button", name="DELETE").click()
    ...
    expect(page.get_by_role("gridcell", name="--").first).to_be_visible()
