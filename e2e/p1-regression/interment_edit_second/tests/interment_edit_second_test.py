...
def test_example(page: Page) -> None:
    ...
    # Wait for element to be visible
    page.get_by_text("Status Vacant close").wait_for(state='visible', timeout=10000)
    expect(page.get_by_text("Status Vacant close")).to_be_visible()

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-plots-selected-filters-span-value").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-plots-selected-filters-span-value")).to_contain_text("Vacant")
    ...
    # Wait for element to be visible
    page.get_by_text("A B 2").wait_for(state='visible', timeout=10000)
    expect(page.get_by_text("A B 2")).to_be_visible()
    ...
    expect(page.locator("#mat-expansion-panel-header-1")).to_contain_text("Deceased person")

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right")).to_contain_text("interment applicant")

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right")).to_contain_text("next of kin")

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right")).to_contain_text("funeral minister")

    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-a20b202-manage-add-interment-interment-add-form-div-right")).to_contain_text("funeral director")
    ...
    # Wait for element to be visible
    page.get_by_test_id("customer-organization-astana-tegal-gundul-plots-a20b202-plot-details-edit-div-cemetery-name-wrapper").get_by_text("Astana Tegal Gundul").wait_for(state='visible', timeout=10000)
    expect(page.get_by_test_id("customer-organization-astana-tegal-gundul-plots-a20b202-plot-details-edit-div-cemetery-name-wrapper").get_by_text("Astana Tegal Gundul")).to_be_visible()
